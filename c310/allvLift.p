...
plot"c310-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "c310-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "c310-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "c310-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
