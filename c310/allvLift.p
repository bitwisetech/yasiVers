...
plot"c310-datv2017-2.txt" every ::2        using 1:2 with lines title 'Lift v2017-2', \
    "c310-datvOrig.txt" every ::2        using 1:2 with lines title 'Lift vOrig', \
    "c310-datvCurr.txt" every ::2        using 1:2 with lines title 'Lift vCurr', \
    "c310-datv32.txt" every ::2        using 1:2 with lines title 'Lift v32', \
