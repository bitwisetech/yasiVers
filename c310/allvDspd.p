...
plot"c310-dspd-vOrig.txt" every 4::3        using 1:2 with line title 'DragVsSpd vOrig', \
    "c310-dspd-vNone.txt" every 4::3        using 1:2 with line title 'DragVsSpd vNone', \
    "c310-dspd-v32.txt" every 4::3        using 1:2 with impulses title 'DragVsSpd v32', \
    "c310-dspd-v2017-2.txt" every 4::3        using 1:2 with linespoints title 'DragVsSpd v2017-2', \
