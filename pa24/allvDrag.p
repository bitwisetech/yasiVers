...
plot"pa24-datvOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "pa24-datv32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "pa24-datvCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "pa24-datv2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
