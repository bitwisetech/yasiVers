...
plot"pa24-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "pa24-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "pa24-vdat-vCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "pa24-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
