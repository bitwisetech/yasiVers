# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "compVers.py 772E All Versions : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
plot"772E-datvOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "772E-datv32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "772E-datvCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "772E-datv2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
