...
plot"772E-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "772E-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "772E-vdat-vCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "772E-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
