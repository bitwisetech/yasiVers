...
plot"772E-datvOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "772E-datv32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "772E-datvCurr.txt" every 4::2        using 1:4 with points title 'LvsD vCurr', \
    "772E-datv2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
