...
plot"772E-vdat-vOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "772E-vdat-v32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "772E-vdat-vCurr.txt" every 4::2        using 1:4 with points title 'LvsD vCurr', \
    "772E-vdat-v2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
