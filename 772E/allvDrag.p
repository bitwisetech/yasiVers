...
plot"772E-datvOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "772E-datv32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "772E-datvCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "772E-datv2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
