...
plot"AN225-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "AN225-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "AN225-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "AN225-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
