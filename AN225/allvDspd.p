...
plot"AN225-dspd-vOrig.txt" every 4::3        using 1:2 with line title 'DragVsSpd vOrig', \
    "AN225-dspd-vNone.txt" every 4::3        using 1:2 with line title 'DragVsSpd vNone', \
    "AN225-dspd-v32.txt" every 4::3        using 1:2 with impulses title 'DragVsSpd v32', \
    "AN225-dspd-v2017-2.txt" every 4::3        using 1:2 with linespoints title 'DragVsSpd v2017-2', \
