# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "compVers.py 772Z All Versions : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
plot"772Z-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "772Z-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "772Z-vdat-vCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "772Z-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
