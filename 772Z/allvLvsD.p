...
plot"772Z-datvOrig.txt" every 6::2        using 1:4 with line title 'LvsD vOrig', \
    "772Z-datv32.txt" every 6::2        using 1:4 with impulses title 'LvsD v32', \
    "772Z-datvCurr.txt" every 6::2        using 1:4 with points title 'LvsD vCurr', \
    "772Z-datv2017-2.txt" every 6::2        using 1:4 with linespoints title 'LvsD v2017-2', \
