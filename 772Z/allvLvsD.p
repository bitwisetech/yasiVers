...
plot"772Z-datv2017-2.txt" every ::2        using 1:4 with lines title 'LvsD v2017-2', \
    "772Z-datvOrig.txt" every ::2        using 1:4 with lines title 'LvsD vOrig', \
    "772Z-datvCurr.txt" every ::2        using 1:4 with lines title 'LvsD vCurr', \
    "772Z-datv32.txt" every ::2        using 1:4 with lines title 'LvsD v32', \
