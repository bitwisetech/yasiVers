# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "yasiVers.py 772Z v32 : 210kTAS at 10ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
#      "outpData.txt" every ::155::210 using 1:4 with lines title 'LD'
 plot "772Z-datv32.txt" every ::2        using 1:2 with lines title 'lift', \
      "772Z-datv32.txt" every ::2        using 1:3 with lines title 'drag', \
      "772Z-datv32.txt" every ::2        using 1:4 with lines title 'L-D' 
