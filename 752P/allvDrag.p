...
plot"752P-datvOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "752P-datv32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "752P-datvCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "752P-datv2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
