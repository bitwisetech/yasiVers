# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "yasiVers.py 752P v2017-2 : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
#      "outpData.txt" every ::155::210 using 1:4 with lines title 'LD'
 plot "752P-datv2017-2.txt" every ::2        using 1:2 with lines title 'lift', \
      "752P-datv2017-2.txt" every ::2        using 1:3 with lines title 'drag', \
      "752P-datv2017-2.txt" every ::2        using 1:4 with lines title 'L-D' 
