...
plot"752P-datvOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "752P-datv32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "752P-datvCurr.txt" every 4::2        using 1:4 with points title 'LvsD vCurr', \
    "752P-datv2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
