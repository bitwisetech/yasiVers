...
plot"752P-vdat-vOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "752P-vdat-v32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "752P-vdat-vCurr.txt" every 4::2        using 1:4 with points title 'LvsD vCurr', \
    "752P-vdat-v2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
