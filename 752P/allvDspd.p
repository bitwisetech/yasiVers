...
plot"752P-dspd-vOrig.txt" every 4::3        using 1:2 with line title 'DragVsSpd vOrig', \
    "752P-dspd-vNone.txt" every 4::3        using 1:2 with line title 'DragVsSpd vNone', \
    "752P-dspd-v32.txt" every 4::3        using 1:2 with impulses title 'DragVsSpd v32', \
    "752P-dspd-v2017-2.txt" every 4::3        using 1:2 with linespoints title 'DragVsSpd v2017-2', \
