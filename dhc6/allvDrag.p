...
plot"./dhc6-datv2017-2.txt" every ::2        using 1:3 with lines title 'Drag v2017-2', \
    "./dhc6-datvOrig.txt" every ::2        using 1:3 with lines title 'Drag vOrig', \
    "./dhc6-datvCurr.txt" every ::2        using 1:3 with lines title 'Drag vCurr', \
    "./dhc6-datv32.txt" every ::2        using 1:3 with lines title 'Drag v32', \
