...
plot"772L-vdat-vOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "772L-vdat-vNone.txt" every 4::2        using 1:4 with line title 'LvsD vNone', \
    "772L-vdat-v32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "772L-vdat-v2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
