...
plot"cit2-datv2017-2.txt" every ::2        using 1:2 with lines title 'Lift v2017-2', \
    "cit2-datvOrig.txt" every ::2        using 1:2 with lines title 'Lift vOrig', \
    "cit2-datvCurr.txt" every ::2        using 1:2 with lines title 'Lift vCurr', \
    "cit2-datv32.txt" every ::2        using 1:2 with lines title 'Lift v32', \
