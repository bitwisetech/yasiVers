# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "compVers.py cit2 All Versions : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
plot"cit2-datv2017-2.txt" every ::2        using 1:4 with lines title 'LvsD v2017-2', \
    "cit2-datvOrig.txt" every ::2        using 1:4 with lines title 'LvsD vOrig', \
    "cit2-datvCurr.txt" every ::2        using 1:4 with lines title 'LvsD vCurr', \
    "cit2-datv32.txt" every ::2        using 1:4 with lines title 'LvsD v32', \
