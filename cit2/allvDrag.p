...
plot"cit2-datv2017-2.txt" every ::2        using 1:3 with lines title 'Drag v2017-2', \
    "cit2-datvOrig.txt" every ::2        using 1:3 with lines title 'Drag vOrig', \
    "cit2-datvCurr.txt" every ::2        using 1:3 with lines title 'Drag vCurr', \
    "cit2-datv32.txt" every ::2        using 1:3 with lines title 'Drag v32', \
