...
plot"752R-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "752R-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "752R-vdat-vCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "752R-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
