...
plot"752R-datvOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "752R-datv32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "752R-datvCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "752R-datv2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
