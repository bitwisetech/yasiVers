...
plot"752R-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "752R-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "752R-vdat-vCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "752R-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
