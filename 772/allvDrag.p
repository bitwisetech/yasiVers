...
plot"772-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "772-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "772-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "772-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
