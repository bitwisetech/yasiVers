# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "yasiVers.py J3Cub v2017-2 : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
#      "outpData.txt" every ::155::210 using 1:4 with lines title 'LD'
 plot "J3Cub-datv2017-2.txt" every ::2        using 1:2 with lines title 'lift', \
      "J3Cub-datv2017-2.txt" every ::2        using 1:3 with lines title 'drag', \
      "J3Cub-datv2017-2.txt" every ::2        using 1:4 with lines title 'L-D' 
