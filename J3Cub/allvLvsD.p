...
plot"J3Cub-vdat-vOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "J3Cub-vdat-vNone.txt" every 4::2        using 1:4 with line title 'LvsD vNone', \
    "J3Cub-vdat-v32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "J3Cub-vdat-v2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
