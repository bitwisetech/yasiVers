...
plot"J3Cub-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "J3Cub-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "J3Cub-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "J3Cub-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
