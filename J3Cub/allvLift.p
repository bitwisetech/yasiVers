...
plot"J3Cub-datvOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "J3Cub-datv32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "J3Cub-datvCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "J3Cub-datv2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
