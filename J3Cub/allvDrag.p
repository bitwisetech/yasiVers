...
plot"J3Cub-datvOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "J3Cub-datv32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "J3Cub-datvCurr.txt" every 4::2        using 1:3 with points title 'Drag vCurr', \
    "J3Cub-datv2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
