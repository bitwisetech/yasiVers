...
plot"J3Cub-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "J3Cub-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "J3Cub-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "J3Cub-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
