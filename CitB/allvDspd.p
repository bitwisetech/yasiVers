...
plot"CitB-dspd-vOrig.txt" every 4::3        using 1:2 with line title 'DragVsSpd vOrig', \
    "CitB-dspd-vNone.txt" every 4::3        using 1:2 with line title 'DragVsSpd vNone', \
    "CitB-dspd-v32.txt" every 4::3        using 1:2 with impulses title 'DragVsSpd v32', \
    "CitB-dspd-v2017-2.txt" every 4::3        using 1:2 with linespoints title 'DragVsSpd v2017-2', \
