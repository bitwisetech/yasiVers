...
plot"CitX-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "CitX-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "CitX-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "CitX-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
