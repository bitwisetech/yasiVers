...
plot"aa1-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "aa1-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "aa1-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "aa1-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
