...
plot"aa1-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "aa1-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "aa1-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "aa1-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
