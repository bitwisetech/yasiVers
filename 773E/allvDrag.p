...
plot"773E-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "773E-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "773E-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "773E-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
