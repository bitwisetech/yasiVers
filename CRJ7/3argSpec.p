# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "yasiVers.py CRJ7 v32 : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
#      "outpData.txt" every ::155::210 using 1:4 with lines title 'LD'
 plot "CRJ7-datv32.txt" every ::2        using 1:2 with lines title 'lift', \
      "CRJ7-datv32.txt" every ::2        using 1:3 with lines title 'drag', \
      "CRJ7-datv32.txt" every ::2        using 1:4 with lines title 'L-D' 
