...
plot"CRJ7-vdat-vOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "CRJ7-vdat-vNone.txt" every 4::2        using 1:2 with line title 'Lift vNone', \
    "CRJ7-vdat-v32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "CRJ7-vdat-v2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
