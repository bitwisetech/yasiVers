# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "compVers.py CRJ7 All Versions : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
plot"CRJ7-datv2017-2.txt" every ::2        using 1:2 with lines title 'Lift v2017-2', \
    "CRJ7-datvOrig.txt" every ::2        using 1:2 with lines title 'Lift vOrig', \
    "CRJ7-datvCurr.txt" every ::2        using 1:2 with lines title 'Lift vCurr', \
    "CRJ7-datv32.txt" every ::2        using 1:2 with lines title 'Lift v32', \
