...
plot"CRJ7-datv2017-2.txt" every ::2        using 1:4 with lines title 'LvsD v2017-2', \
    "CRJ7-datvOrig.txt" every ::2        using 1:4 with lines title 'LvsD vOrig', \
    "CRJ7-datvCurr.txt" every ::2        using 1:4 with lines title 'LvsD vCurr', \
    "CRJ7-datv32.txt" every ::2        using 1:4 with lines title 'LvsD v32', \
