...
plot"CRJ7-datv2017-2.txt" every ::2        using 1:3 with lines title 'Drag v2017-2', \
    "CRJ7-datvOrig.txt" every ::2        using 1:3 with lines title 'Drag vOrig', \
    "CRJ7-datvCurr.txt" every ::2        using 1:3 with lines title 'Drag vCurr', \
    "CRJ7-datv32.txt" every ::2        using 1:3 with lines title 'Drag v32', \
