...
plot"CRJ7-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "CRJ7-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "CRJ7-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "CRJ7-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
