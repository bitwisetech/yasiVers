...
plot"pa28-datvOrig.txt" every 4::2        using 1:2 with line title 'Lift vOrig', \
    "pa28-datv32.txt" every 4::2        using 1:2 with impulses title 'Lift v32', \
    "pa28-datvCurr.txt" every 4::2        using 1:2 with points title 'Lift vCurr', \
    "pa28-datv2017-2.txt" every 4::2        using 1:2 with linespoints title 'Lift v2017-2', \
