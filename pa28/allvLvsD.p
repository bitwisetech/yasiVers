...
plot"pa28-datvOrig.txt" every 4::2        using 1:4 with line title 'LvsD vOrig', \
    "pa28-datv32.txt" every 4::2        using 1:4 with impulses title 'LvsD v32', \
    "pa28-datvCurr.txt" every 4::2        using 1:4 with points title 'LvsD vCurr', \
    "pa28-datv2017-2.txt" every 4::2        using 1:4 with linespoints title 'LvsD v2017-2', \
