...
plot"777-200F-datv2017-2.txt" every ::2        using 1:2 with lines title 'Lift v2017-2', \
    "777-200F-datvOrig.txt" every ::2        using 1:2 with lines title 'Lift vOrig', \
    "777-200F-datvCurr.txt" every ::2        using 1:2 with lines title 'Lift vCurr', \
    "777-200F-datv32.txt" every ::2        using 1:2 with lines title 'Lift v32', \
