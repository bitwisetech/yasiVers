...
plot"772F-vdat-vOrig.txt" every 4::2        using 1:3 with line title 'Drag vOrig', \
    "772F-vdat-vNone.txt" every 4::2        using 1:3 with line title 'Drag vNone', \
    "772F-vdat-v32.txt" every 4::2        using 1:3 with impulses title 'Drag v32', \
    "772F-vdat-v2017-2.txt" every 4::2        using 1:3 with linespoints title 'Drag v2017-2', \
