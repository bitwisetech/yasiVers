...
plot"777-200F-datv2017-2.txt" every ::2        using 1:3 with lines title 'Drag v2017-2', \
    "777-200F-datvOrig.txt" every ::2        using 1:3 with lines title 'Drag vOrig', \
    "777-200F-datvCurr.txt" every ::2        using 1:3 with lines title 'Drag vCurr', \
    "777-200F-datv32.txt" every ::2        using 1:3 with lines title 'Drag v32', \
