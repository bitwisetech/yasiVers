# Gnuplot script file for "outpData.txt"
 ...
 show grid
 set title "yasiVers.py 777-200F v32 : 180kTAS at 2000ft" 
# set xlabel "AoA (Deg)"
# set ylabel "Force (G)"
...
#      "outpData.txt" every ::155::210 using 1:4 with lines title 'LD'
 plot "777-200F-datv32.txt" every ::2        using 1:2 with lines title 'lift', \
      "777-200F-datv32.txt" every ::2        using 1:3 with lines title 'drag', \
      "777-200F-datv32.txt" every ::2        using 1:4 with lines title 'L-D' 
